...
| editDocumentMessageId | string | Esse atributo permite editar a descrição de documentos enviados anteriormente no WhatsApp. Use o ID da mensagem e o novo caption no JSON para fazer alterações. É necessário configurar o webhook antes de editar (Apenas o caption pode ser editado). |
